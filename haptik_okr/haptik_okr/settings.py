"""
Django settings for haptik_okr project.
...
SECRET_KEY = '_ukkhlrd+7-1-p=a_v#x&27a##icxbuas3!7s5)m+)miebf++u'
...
WSGI_APPLICATION = 'haptik_okr.wsgi.application'
